...
function toCard(row: CardRow): Card {
  return {
    ...
    progressPeriodStart: (row.progressPeriodStart ?? undefined) as ISODate | undefined,
    progressPeriodEnd: (row.progressPeriodEnd ?? undefined) as ISODate | undefined,
...
function cardValues(userId: string, input: CreateCardInput): typeof cards.$inferInsert {
  return {
    ...
    progressPeriodStart: input.progressPeriodStart ?? null,
    progressPeriodEnd: input.progressPeriodEnd ?? null,
      ...
      async update(
        ...
        await db
          ...
          .set({
            ...
            progressPeriodStart: next.progressPeriodStart ?? null,
            progressPeriodEnd: next.progressPeriodEnd ?? null,
